...
class Application(tk.Frame):
	...
	def createEntryWindows(self,file=None):
		if (file != None):
			...
			self.spec1radio1 = tk.Radiobutton(self, text='"Title" (TEXTED VERSION)',value='"'+self.titlevar.get()+'" (TEXTED VERSION)',variable=self.spec1var).grid(row=5,column=1,sticky=tk.W,padx=10)
			self.spec1radio2 = tk.Radiobutton(self, text='"Title" (TEXTLESS VERSION) ',value='"'+self.titlevar.get()+'" (TEXTLESS VERSION)',variable=self.spec1var).grid(row=5,column=1,sticky=tk.E,padx=10)
